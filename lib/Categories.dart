...
import 'package:sqflite_project/Aintelligence.dart';
...
class _CategoriesState extends State<Categories> {
  ...
  Color themecolor1=Color(0XFF915FBF);
   Color themecolor2=Color(0XFFCA436B);
...
//  final _dashboardpage=_category(context);
  ...
  _onchanged()
 {
    if(themecolor1==Color(0XFF915FBF))
   {
     setState(() {
   ...
   {
     setState(() {
       themecolor1=Colors.green;
      //  themecolor2=Colors.orange;
       bulb=Icon(FontAwesomeIcons.solidLightbulb,color: Colors.white,);
     });
   }
   else 
   if(themecolor1==Colors.green)
   {
     setState(() {
   ...
   if(themecolor2==Colors.black87)
   {
     setState(() {
       themecolor1=Color.fromARGB(255,33,30,30);
       themecolor2=Color.fromARGB(255,33,30,30);
       bulb=Icon(FontAwesomeIcons.solidLightbulb,color: Colors.white,);
     });
   }else
      if(themecolor2==Color.fromARGB(255,33,30,30))
   {
     setState(() {
       themecolor1=Colors.black;
   ...
   {
     setState(() {
      themecolor1=Color(0XFF915FBF);
      themecolor2= Color(0XFFCA436B);
      bulb=Icon(FontAwesomeIcons.lightbulb,color: Colors.white,);
     });
   }
 }
